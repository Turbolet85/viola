...
- **Closed enums:**
  ...
  - `run --mutants` `mutants.verdict`: `counted`, `no-rust-delta`. Leg-verdict `outcome`: `caught`, `missed`, `timeout`, `unviable`.
