...
- Command body: `scripts/agent-run.sh boot [--session <id>] [--instance <name>[:<fake-agent-args>]]... [--ui] [--unstamped] [--cli-version <ver>]`. The default is instances `overseer` and `builder` plus `--ui`. Steps:
