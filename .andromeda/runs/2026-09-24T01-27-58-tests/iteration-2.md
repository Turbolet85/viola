...
- **Steps:**
  ...
  2. Pipe proptest-generated stdin `{"rate_limits":{"five_hour":{"used_percentage":91,"resets_at":"<RFC3339>"},"seven_day":{"used_percentage":10,…}}}` into `viola hook statusline` with `VIOLA_NAME=builder VIOLA_DIR=…`.
