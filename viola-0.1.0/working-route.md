...
Security prerequisites — SQOS pipe-handle spike and pure-Rust SHA-256 pick, both recorded ahead of the channel client and bin/ writes; no unprotected-connect fallback  PREREQ: close Rust gate deferral (deferred since 2026-09-24-workspace-tree-and-code-graph-planes)
   ↓
